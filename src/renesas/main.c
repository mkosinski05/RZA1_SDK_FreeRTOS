...
#define PARAM_TO_STR(a) #a

#define R_COMPILER_PUSH() _Pragma( PARAM_TO_STR( GCC diagnostic push ))
#define R_COMPILER_SUPPRES_UNUSED_BUT_SET_VARIABLE() _Pragma( PARAM_TO_STR( GCC diagnostic ignored "-Wunused-but-set-variable" ))
#define R_COMPILER_POP() _Pragma( PARAM_TO_STR( GCC diagnostic pop ))
