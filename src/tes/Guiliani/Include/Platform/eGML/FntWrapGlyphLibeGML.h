...
#ifndef __FNT_WRAP_GLYPHLIB_EGML_H__
#define __FNT_WRAP_GLYPHLIB_EGML_H__
...
/// Glyphlib font wrapper specialization using eGML bitmaps.

/** This implementation uses eGML bitmap operations for rendering.
*/
class CFntWrapGlyphLibeGML : public CFntWrapGlyphLib
{
public:
...
private:
    /*
        ...
        @param uiMaxNumSizeObjects Maximum number of opened size objects managed by the FreeType cache.
    */
    CFntWrapGlyphLibeGML(const eC_UInt& uiCacheSize,
                         eGML_Screen* pScreen,
                         const eC_UInt& uiMaxNumFaces,
                         const eC_UInt& uiMaxNumSizeObjects
                         );

    virtual ~CFntWrapGlyphLibeGML(void);

    /** Copy-constructor.
        Dummy implementation to avoid unintended use of compiler-generated default
        */
    CFntWrapGlyphLibeGML(const CFntWrapGlyphLibeGML& kSource);

    /** Operator= method.
        Dummy implementation to avoid unintended use of compiler-generated default
    */
    CFntWrapGlyphLibeGML& operator=(const CFntWrapGlyphLibeGML& kSource);
